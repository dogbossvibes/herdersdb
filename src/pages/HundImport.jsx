...
export default function HundImport() {
  ...
  const handleSave = async () => {
    ...
    const { error } = await supabase.from("dogs").insert({
      ...
      hd:               form.hd               || null,
      ed:               form.ed               || null,
      augen:            form.augen            || null,
      herz:             form.herz             || null,
      health_date:      form.health_date      || null,
      health_vet:       form.health_vet       || null,
      mdr1:             form.mdr1             || null,
      dew:              form.dew              || null,
      dna_labor:        form.dna_labor        || null,
      dna_date:         form.dna_date         || null,
      coi_genomic:      form.coi_genomic      ? Number(form.coi_genomic) : null,
      schutzdienst:     form.schutzdienst     || null,
      faehrte:          form.faehrte          || null,
      obedience:        form.obedience        || null,
      sport:            form.sport            || null,
      zuchteigung:      form.zuchteigung      || null,
      titles_notes:     form.titles_notes     || null,
      owner:            form.owner            || null,
      breeder:          form.breeder          || null,
      kennel:           form.kennel           || null,
      breeding_approved:form.breeding_approved|| null,
      workingdog_url:   form.workingdog_url   || null,
